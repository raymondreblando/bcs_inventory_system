    ...
    <main>
      <div class="h-[4.55rem] flex items-center justify-between gap-4 bg-white border-b border-b-gray-300/40 py-3 px-6">
        <div class="flex items-center gap-3">
          ...
          <p class="text-[15px] font-semibold text-black">Update Account</p>
        </div>
      ...
      <div class="py-6 px-6">
        <div class="max-w-[800px] border border-gray-300/40 rounded-md mx-auto py-6 px-8">
          ...
          <p class="text-xl font-semibold uppercase">Update Account Data</p>
          <p class="text-sm text-gray-500 mb-8">To update the account, you can edit the below account information.</p>
          <form autocomplete="off" id="updateAccountForm">
          <div class="grid md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                <div>
                  ...
                  <input type="text" id="firstname" value="<?php echo $user_details->fname ?>" class="w-full h-12 text-sm text-gray-500 outline-none px-4 rounded-sm placeholder:text-gray-500 border border-gray-300/40 mb-3" placeholder="Enter firstname">
                </div>
                <div>
                  <label for="middlename" class="block text-sm font-medium text-gray-800 mb-2">Middlename</label>
                  <input type="text" id="middlename" value="<?php echo $user_details->middle ?>" class="w-full h-12 text-sm text-gray-500 outline-none px-4 rounded-sm placeholder:text-gray-500 border border-gray-300/40 mb-3" placeholder="Enter middlename">
                </div>
                <div>
                  <label for="lastname" class="block text-sm font-medium text-gray-800 mb-2">Lastname</label>
                  <input type="text" id="lastname" value="<?php echo $user_details->lname ?>" class="w-full h-12 text-sm text-gray-500 outline-none px-4 rounded-sm placeholder:text-gray-500 border border-gray-300/40 mb-3" placeholder="Enter lastname">
                </div>
              </div>
            </div>
            <div class="grid md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                <input type="text" id="phone_number" value="<?php echo $user_details->contact ?>" class="w-full h-12 text-sm text-gray-500 outline-none px-4 rounded-sm placeholder:text-gray-500 border border-gray-300/40 " placeholder="Enter phone number">
              </div>
              <div>
                <label for="email_address" class="block text-sm font-medium text-gray-800 mb-2">Email Address</label>
                <input type="email" id="email_address" value="<?php echo $user_details->email ?>" class="w-full h-12 text-sm text-gray-500 outline-none px-4 rounded-sm placeholder:text-gray-500 border border-gray-300/40 " placeholder="Enter email address">
              </div>
              <div>
                <label for="address" class="block text-sm font-medium text-gray-800 mb-2">Address</label>
                <input type="text" id="address" value="<?php echo $user_details->address ?>" class="w-full h-12 text-sm text-gray-500 outline-none px-4 rounded-sm placeholder:text-gray-500 border border-gray-300/40 " placeholder="Enter address">
              </div> 
              <div>
                <label for="password" class="block text-sm font-medium text-gray-800 mb-2">New Password</label>
                <input type="password" id="pass" class="w-full h-12 text-sm text-gray-500 outline-none px-4 rounded-sm placeholder:text-gray-500 border border-gray-300/40 " placeholder="Enter new password">
              </div> 
            </div>
            <div class="flex items-center gap3">
              <button type="button" id="updateAccount" data-id="<?php echo $id ?>" class="bg-primary text-white text-xs font-medium uppercase py-4 px-8 rounded-md">Update Account</button>
            </div>
          </form>
        </div>
      </div>
